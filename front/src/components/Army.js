      ...
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          setTimeout(() => {
            setSubmitting(false);
            const archerArmy =
              Math.floor(values.archerQty) > 0
                ? Math.floor(values.archerQty)
                : 0;
            const knightArmy =
              Math.floor(values.knightQty) > 0
                ? Math.floor(values.knightQty)
                : 0;
            const horseRiderArmy =
              Math.floor(values.horseRidersQty) > 0
                ? Math.floor(values.horseRidersQty)
                : 0;
